...
public class SignUpClsView extends javax.swing.JFrame {

    public SignUpClsView() {
        initComponents();
    ...
    public void displayUserListIntoTable() {
        List<UserCls> list = UserServiceCls.getUserList();
...
public void clearForm() {
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
        ...
        UserCls user = new UserCls(txtusername.getText().trim(), txtPass.getText().trim(), ut, txtFirstName.getText().trim(), txtLastName.getText().trim(), txtEmail.getText().trim(), txtMobile.getText().trim(), new Date(), true);
        UserServiceCls.insert(user);
        clearForm();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpClsView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
