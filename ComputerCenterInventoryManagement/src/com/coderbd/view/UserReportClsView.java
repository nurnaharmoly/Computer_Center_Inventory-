 ...
 * @author User
 */
public class UserReportClsView extends javax.swing.JFrame {

    /**
     * Creates new form DashBoard
     */
    public UserReportClsView() {
        initComponents();
    ...
    public void displayUserByUserTypeAndStatusIntoTable() {
        ...
        List<UserCls> list = ReportServiceCls.getUserListByUserTypeAndStatus(selectType, status);
    ...
    public void displayUserByUserTypeIntoTable() {
        ...
        List<UserCls> list = ReportServiceCls.getUserListByUserType(selectType);
        for (int i = 0; i < list.size(); i++) {
            row[0] = list.get(i).getUserName();
            row[1] = list.get(i).getUserType();
            row[2] = list.get(i).getFirstName() + " " + list.get(i).getLastName();
    ...
    private void initComponents() {
        ...
        jPanel4.setBackground(new java.awt.Color(120, 175, 195));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserReportClsView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
